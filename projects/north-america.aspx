<%@ Page Language="VB" MasterPageFile="~/website.master" AutoEventWireup="false"
    CodeFile="north-america.aspx.vb" Inherits="_Default" Title="North America Projects - HPF Energy Services - Total Support for all your Pipeline Product requirements from the highest of Quality Sources." %>
                    ...
                    <asp:UpdatePanel ID="upProjects" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:AccessDataSource ID="accDSRegion" DataFile="~/App_Data/hpf_updateable.mdb" runat="server"
                                SelectCommand="SELECT DISTINCT Location FROM contracts WHERE [World Region] = 'North America' ORDER BY Location asc">
                            </asp:AccessDataSource>
                            <asp:AccessDataSource ID="accDS" DataFile="~/App_Data/hpf_updateable.mdb" runat="server"
                                SelectCommand="SELECT [ID], [Title], [User/Operator], [Contractor], [Location], [World Region], [Products Supplied], [Contract Type], [Complete] FROM contracts WHERE [World Region] = 'North America' AND [Location] LIKE '%' + @Location + '%'">
                                <SelectParameters>
