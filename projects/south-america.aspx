<%@ Page Language="VB" MasterPageFile="~/website.master" AutoEventWireup="false"
    CodeFile="south-america.aspx.vb" Inherits="_Default" Title="South America Projects - HPF Energy Services - Total Support for all your Pipeline Product requirements from the highest of Quality Sources." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="mainWrapper">
        ...
        <div id="content">
            ...
            <p>
                <strong>We currently have no projects in the South America region.</strong>
            </p>
            <div class="projectWrapper">
                <div id="contentFormProjects">
                    <h2>
                        Projects - South America Region
                    </h2>
                    <asp:UpdatePanel ID="upProjects" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:AccessDataSource ID="accDSRegion" DataFile="~/App_Data/hpf_updateable.mdb" runat="server"
                                SelectCommand="SELECT DISTINCT Location FROM contracts WHERE [World Region] = 'South America' ORDER BY Location asc">
                            </asp:AccessDataSource>
                            <asp:AccessDataSource ID="accDS" DataFile="~/App_Data/hpf_updateable.mdb" runat="server"
                                SelectCommand="SELECT [ID], [Title], [User/Operator], [Contractor], [Location], [World Region], [Products Supplied], [Contract Type], [Complete] FROM contracts WHERE [World Region] = 'South America' AND [Location] LIKE '%' + @Location + '%'">
                                <SelectParameters>
