...
Partial Class _Default
    ...
    Protected Sub ddlOrderBy_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOrderBy.SelectedIndexChanged
        accDS.SelectCommand = "SELECT [ID], [Title], [User/Operator], [Contractor], [Location], [World Region], [Products Supplied], [Contract Type], [Complete] FROM contracts WHERE [World Region] = 'Australasia' AND [Location] LIKE '%' + @Location + '%' ORDER BY [" + ddlOrderBy.SelectedValue + "];"
        rptProjects.DataBind()
    End Sub
End Class
