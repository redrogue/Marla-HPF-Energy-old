<%@ Page Language="VB" MasterPageFile="~/website.master" AutoEventWireup="false"
    CodeFile="europe.aspx.vb" Inherits="_Default" Title="Europe Projects - HPF Energy Services - Total Support for all your Pipeline Product requirements from the highest of Quality Sources." %>
            ...
            <div class="projectWrapper">
                <div id="contentFormProjects">
                    ...
                    <asp:AccessDataSource ID="accDSRegion" DataFile="~/App_Data/hpf_updateable.mdb" runat="server"
                        SelectCommand="SELECT DISTINCT Location FROM contracts WHERE [World Region] = 'Europe' ORDER BY Location asc">
                    </asp:AccessDataSource>
                    <asp:AccessDataSource ID="accDS" DataFile="~/App_Data/hpf_updateable.mdb" runat="server"
                        SelectCommand="SELECT [ID], [Title], [User/Operator], [Contractor], [Location], [World Region], [Products Supplied], [Contract Type], [Complete] FROM contracts WHERE [World Region] = 'Europe' AND [Location] LIKE '%' + @Location + '%'">
                        <SelectParameters>
